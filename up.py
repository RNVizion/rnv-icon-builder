...
rnv-icon-builder: make the test-tooling pins agree with the other four applications.
...
WHAT THIS DOES. Rewrites 4 specifier(s) in 1 file(s) to the fleet
...
EDITS = [('tests/requirements-dev.txt', 'pytest>=8.0.0,<9.0.0\n', 'pytest>=8.0,<10.0\n', 1), ('tests/requirements-dev.txt', 'pytest-qt>=4.4.0,<5.0.0\n', 'pytest-qt>=4.4,<5.0\n', 1), ('tests/requirements-dev.txt', 'pytest-cov>=5.0.0,<7.0.0\n', 'pytest-cov>=5.0,<8.0\n', 1), ('tests/requirements-dev.txt', 'pytest-benchmark>=4.0.0,<6.0.0\n', 'pytest-benchmark>=4.0,<6.0\n', 1)]
