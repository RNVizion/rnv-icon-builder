...
Re-walk rnv-icon-builder's light status text to the boundary the gold already stops at.
...
MISSING_HELP = (
    "run this from the root of a rnv-icon-builder checkout.\n\n"
    "If you ARE in one, the status-family migration has not been applied here "
    "yet -- run up-for-rnv-icon-builder-status-family.py first. This script only moves "
...
REWALK = {'#8a6581': '#825d79', '#976633': '#8e5e2b'}
...
ALREADY = {'STATUS_SUCCESS': '#926c89', 'STATUS_WARNING': '#a2703c'}
...
QUOTE = '"'
NAMES = ['STATUS_SUCCESS_TEXT_LIGHT', 'STATUS_WARNING_TEXT_LIGHT']
BEFORE = {'STATUS_SUCCESS_TEXT_LIGHT': '#8a6581', 'STATUS_WARNING_TEXT_LIGHT': '#976633'}
VALUE_FILES = ['ui/colors.py', 'tests/test_status_register.py']
